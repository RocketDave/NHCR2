...
<?php   if(    isset($submit_message))    {    
    ...
    <h3 class="text-danger"> Colonoscopy VIEW ONLY</h3>
    <div>
    ...
    <div class="form-group row">
      <label class="control-label-left col-md-2 text-left" for="exam_date">1. Date of Procedure</label>
        <div class="col-md-2">
            <input class="form-control col-md-2" type="date" name="exam_date" id="exam_date" value="<?php echo $exam_date; ?>" disabled>
        </div>
    </div>
  ...
  <table class="table table-bordered table-condensed">
    ...
    <tr>
        ...
        <td><input type="checkbox" name="p_siz_a" value="5" <?php echo $p_siz_a=="5"?"checked":""; ?>></td>
    ...
    <tr>
        ...
        <td><input type="checkbox" name="p_siz_b" value="5" <?php echo $p_siz_b=="5"?"checked":""; ?>></td>
    ...
    <tr>
        ...
        <td><input type="checkbox" name="p_siz_c" value="5" <?php echo $p_siz_c=="5"?"checked":""; ?>></td>
    ...
    <tr>
        ...
        <td><input type="checkbox" name="p_siz_d" value="5" <?php echo $p_siz_d=="5"?"checked":""; ?>></td>
    ...
    <tr>
        ...
        <td><input type="checkbox" name="p_siz_e" value="5" <?php echo $p_siz_e=="5"?"checked":""; ?>></td>
    ...
    <tr>
        ...
        <td><input type="checkbox" name="p_siz_f" value="5" <?php echo $p_siz_f=="5"?"checked":""; ?>></td>
    ...
    <tr>
        ...
        <td><input type="checkbox" name="p_siz_g" value="5" <?php echo $p_siz_g=="5"?"checked":""; ?>></td>
...
<div class="col-md-6" >
    ...
    <div class="form-group row">
        ...
        <label class="radio-inline">
                <input type="radio" name="prep_type" value="1" <?php echo $prep_type=="1"?"checked":""; ?> >Nulytely or similar(gallon)</label>
        </div>
        <div class="col-md-1">
        <label class="radio-inline">
            <input type="radio" name="prep_type" value="2" <?php echo $prep_type=="2"?"checked":""; ?> >Half-lytely</label>
        </div>
        <div class="col-md-1">
        <label class="radio-inline">
            <input type="radio" name="prep_type" value="3" <?php echo $prep_type=="3"?"checked":""; ?> >Osmoprep (pills)</label>
        </div>
        <div class="col-md-1">
        <label class="radio-inline">
            <input type="radio" name="prep_type" value="4" <?php echo $prep_type=="4"?"checked":""; ?> >Fleet prep kit</label>
        </div>
        <div class="col-md-1">
        <label class="radio-inline">
            <input type="radio" name="prep_type" value="5" <?php echo $prep_type=="5"?"checked":""; ?> >Other</label>
        </div>
    </div>
