...
<?php if (isset($_SESSION['batch_id']) and $last_name!= "" and $first_name != "" and $gender_calcd!= "" and $errors==0) {
        echo '<div><button id="add_event" type="button" class="btn btn-primary" name="add_event">New Event</button></div>';
    }

    if ((strtotime($cuttoff)-strtotime($inserted_on))/$daylen < 2) {
...
<script type="text/javascript" src="./js/person_v4.js"></script>
