...
<div class="container-fluid">
    ...
    <div class="form-group row">
        <button id="add_pathrequest" type="button" class="btn btn-primary">Create New Path Requests</a>
    </div>
    <div class="form-group row">
        <a href="pathrequestprint.php" role="button" class="btn btn-primary">Print Requests</a>
    </div>
    <div class="form-group row">
...
<script type="text/javascript" src="./js/pathrequests_v2.js"></script>
