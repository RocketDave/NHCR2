...
if (array_key_exists('confirm_submit', $_POST))   {
    ...
    if ($errors == 0) {
		error_log ('Person ID - '.$person_id);
        try{
            $stmt = pg_prepare($conn,"the_query","select * from public.set_path_report_admin($1,$2,$3)");
            if ($stmt) {
...
if ($errors == 0) {
    $result = pg_query("select * from vPathReport_all where path_report_id = ".$path_report_id);
...
<?php   if(isset($submit_message))    {    
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2">
            <input type="text" name="event_id" class="form-control" id="event_id" value="<?php echo $event_id; ?>">
        </div>
        <label class="control-label col-md-2">Gender</label> 
        <div class="col-md-1">
            <label class="radio">
            <input type="radio" name="gender_calcd" id="gender_m" value="M" <?php echo $gender_calcd=="M"?"checked":""; ?> disabled>Male</label>
        </div>
        <div class="col-md-1">
            <label class="radio">
            <input type="radio" name="gender_calcd" id="gender_f" value="F" <?php echo $gender_calcd=="F"?"checked":""; ?> disabled>Female</label>
        </div>
        <div class="col-md-1">
            <label class="radio">
            <input type="radio" name="gender_calcd" id="gender_u" value="U" <?php echo $gender_calcd=="U"?"checked":""; ?> disabled>Unknown</label>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-md-2">
            <input type="text" name="person_name" class="form-control" id="person_name" value="<?php echo $person_name; ?>" disabled>
        </div>
        <label class="control-label col-md-1">Date of Birth</label>
        <div class="col-md-2">
            <input type="date" name="dob" class="form-control" id="dob" value="<?php echo $dob; ?>"disabled>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2">
            <input type="text" name="endoscopist_id" class="form-control required" id="endoscopist_id" value="<?php echo $endoscopist_id; ?>"disabled>
        </div>
        <label class="control-label col-md-1">Facility</label>
        <div class="col-md-2">
            <input type="text" name="facility_id" class="form-control" id="facility_id" value="<?php echo $facility_id; ?>" disabled> 
        </div>
        ...
        <div class="checkbox col-md-1">
            <input type="checkbox" name="apc" id="apc" value="1" <?php echo $apc=="1"?"checked":""; ?>disabled>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-3">
			<select name="lab_code" class="form-control" id = "lab_code"disabled>
		...
		<div class="col-md-2">
			<select name="pathologist_select" class="form-control" id="pathologist_select"disabled><option> --Select --</option></select>
		</div>
        <label class="control-label col-md-2">Pathology Report Date</label>
        <div class="col-md-2">
            <input type="date" name="pathology_date" class="form-control required" id="pathology_date" min="2004-10-01" value="<?php echo $pathology_date; ?>"disabled>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2">
            <input type="text" name="case_no" class="form-control required" id="case_no" value="<?php echo $case_no; ?>"disabled>
        </div>
        <div class="checkbox col-md-2">
            <label><input type="checkbox" name="amended_path_report" id="amended_path_report" value="1" <?php echo $amended_path_report=="1"?"checked":""; ?>disabled>Amended</label>
        </div>
        <div class="checkbox col-md-1">
            <label><input type="checkbox" name="consult" id="consult" value="1" <?php echo $consult=="1"?"checked":""; ?>disabled>Consult</label>
        </div>
        <div class="col-md-3">
            <label><input type="date" name="consult_date" id="consult_date" class="form-control" value="<?php echo $consult_date; ?>"disabled>Consult Date</label>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="checkbox col-md-1">
            <input type="checkbox" name="date_discrepancy" id="date_discrepancy" value="1"  <?php echo $date_discrepancy=="1"?"checked":""; ?>disabled>
        </div>
        <label class="control-label col-md-2" for ="crohns_only">Crohn's only</label> 
        <div class="checkbox col-md-1">
            <input type="checkbox" name="crohns_only" id="crohns_only" value="1"  <?php echo $crohns_only=="1"?"checked":""; ?>disabled>
        </div>
        <label class="control-label col-md-2" for ="u_colitis_only">Ulcerative Colitis only</label> 
        <div class="checkbox col-md-4">
            <input type="checkbox" name="u_colitis_only" id="u_colitis_only" value="1"  <?php echo $u_colitis_only=="1"?"checked":""; ?>disabled>
        </div>
    </div>
...
<h4> Specimens </h4>
    ...
    <div class="text-center form-group row">
        <a href="pathreports_all.php">Return to Path Reports</a>
    </div>


    <div class="text-center text-danger form-group row">
        <label class="control-label"> Path Report Complete</label> 
            <input type="checkbox" name="path_report_complete" id="path_report_complete" value="1" <?php echo $path_report_complete=="1"?"checked":""; ?> disabled>
    </div>
