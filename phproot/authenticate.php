...
$instances = array(
        'biodev5.evergreen3.dartmouth.edu' => array(
           #     'engine' => 'ddev11w',
                'host' => 'bronzepg92.evergreen3.dartmouth.edu'),
        'biotest5.dartmouth.edu' => array(
            #    'engine' => 'dtest11w',
                'host' => 'silverpg92.evergreen3.dartmouth.edu'),
        'biotest5.evergreen3.dartmouth.edu' => array(
            #    'engine' => 'dtest11w',
                'host' => 'silverpg92.evergreen3.dartmouth.edu'),
        'nhcr2.dartmouth.edu' => array(
              #  'engine' => 'dprod11w',
                'host' => 'goldpg92.evergreen3.dartmouth.edu'),
        'nhcr2.evergreen3.dartmouth.edu' => array(
             #   'engine' => 'dprod11w',
                'host' => 'goldpg92.evergreen3.dartmouth.edu')
);
...
if (!$conn) {
    ...
    header('Location: Login.php');
        ...
        $_SESSION['expiration'] = time() + 18000;
        error_log('Expiration '.$_SESSION['expiration']);
