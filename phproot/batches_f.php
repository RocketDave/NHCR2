...
<div class="container-fluid">
    ...
    <table id="batches" class="table table-striped">
        ...
        <tbody>
            <?php
                $result = pg_query($conn,'select * from public.vbatches_f;');
                if($result){
                    while($row = pg_fetch_array($result))    {
            ?> 
            <tr class="row-links" data-link="batch_f.php" data-id=<?php echo $row['batch_id'];?>>
...
<script type="text/javascript" src="./js/batches_f.js"></script>
