...
$submit_message = "";
isset($_POST['pathologist_code'])?$pathologist_code=$_POST['pathologist_code']:$pathologist_code="";
...
$result = pg_query("select * from Pathologist where pathologist_code = '" . $pathologist_code . "'");
...
<p><p>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-1">
            <input type="text" class="form-control" name="salutation" placeholder="Salutation" value="<?php echo $salutation;?>">
      </div>
      <div class="col-md-2">
      ...
      <div class="col-md-1">
            <input type="text" class="form-control" name="name_suffix" placeholder="suffix" value="<?php echo $name_suffix;?>">
      </div>
      <div class="col-md-1">
            <input type="text" class="form-control" name="degree" placeholder="degree" value="<?php echo $degree;?>">
      </div>
    </div>
