...
<?php   if(isset($submit_message))    {    
    ...
    <div class="form-group row">
      ...
      <div class="col-md-4">
        <input type="text" name="facility_name" class="form-control text-capitalize" id="facility_name" value="<?php echo $facility_name; ?>">
      </div>
      <label class="control-label col-md-2" for ="facility_pseudo_name"> Pseudo name:</label> 
      <div class="col-md-1">
        <input type="text" name="facility_pseudo_name" class="form-control" id="facility_pseudo_name" value="<?php echo $facility_pseudo_name; ?>"readonly>
      </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-6">
        <input type="text" name="address1" id="address1" class="form-control address text-capitalize"  placeholder="address line 1" value="<?php echo $address1; ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-md-2" for="address2"></label>
      <div class="col-md-6">
        <input type="text" name="address2" id="address2" class="form-control address text-capitalize" placeholder="address line 2" value="<?php echo $address2; ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-md-2" for="address3"></label>
      <div class="col-md-6">
        <input type="text" name="address3" id="address3" class="form-control address text-capitalize"  placeholder="address line 3" value="<?php echo $address3; ?>">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-1">
            <input type="text" name="contact1_type" class="form-control text-capitalize" id="contact1_type" value="<?php echo $contact1_type; ?>">
        </div>
        <label class="control-label col-md-1">Name:</label>
        <div class="col-md-2">
            <input type="text" name="contact1_name" class="form-control text-capitalize" id="contact1_name" value="<?php echo $contact1_name; ?>">
        </div>
    ...
    <div class="form-group row">
        <label class="control-label col-md-2">Type:</label>
        <div class="col-md-1">
            <input type="text" name="contact2_type" class="form-control text-capitalize" id="contact2_type" value="<?php echo $contact2_type; ?>">
        </div>
        <label class="control-label col-md-1">Name:</label>
        <div class="col-md-2">
            <input type="text" name="contact2_name" class="form-control text-capitalize" id="contact2_name" value="<?php echo $contact2_name; ?>">
        </div>
        <label class="control-label col-md-1">Phone:</label>
        <div class="col-md-2">
    ...
    <div class="form-group row">
        <label class="control-label col-md-2">Type:</label>
        <div class="col-md-1">
            <input type="text" name="contact3_type" class="form-control text-capitalize" id="contact3_type" value="<?php echo $contact3_type; ?>">
        </div>
        <label class="control-label col-md-1">Name:</label>
        <div class="col-md-2">
            <input type="text" name="contact3_name" class="form-control text-capitalize" id="contact3_name" value="<?php echo $contact3_name; ?>">
        </div>
        <label class="control-label col-md-1">Phone:</label>
        <div class="col-md-2">
            <input type="text" class="form-control" name="contact3_phone" id="contact3_phone" value="<?php echo $contact3_phone;?>">
        </div>
