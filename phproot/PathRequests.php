...
<div class="container-fluid">
    ...
    <div class="form-group row">
        <a href="PathRequest.php" id="add_pathrequest" role="button" class="btn btn-primary">New Path Request</a>
    </div>
</div>
</form>
<br/>
...
<script type="text/javascript" src="./js/pathrequests.js"></script>
