...
$endo_array = array();
$result = pg_query ($conn,'select endoscopist_id as endo_id, mail_name from Endoscopist order by mail_name;' ) ;
        ...
        if ($("#facility_id").val() == '') {
            ...
            xmlhttp.onreadystatechange = function() {
                if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                    document.getElementById("theEndo").innerHTML = xmlhttp.responseText;
                }
            }
            xmlhttp.open("GET","endo_fac.php?q="+endo_id+"&f="+$("#facility_id").val()+"&t=del",true);
            xmlhttp.send();
        }
    }
</script>
