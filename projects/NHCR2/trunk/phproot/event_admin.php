...
<p><p>
    <div class="form-group row">
      ...
      <div class="col-md-1">
        <input type="text" name="person_id" class="form-control" id="person_id" value="<?php echo $person_id; ?>">
      </div>
...
<?php
    ...
    if (((strtotime($cuttoff)-strtotime($inserted_on))/$daylen < 1) or (in_array('nhcr2_admin', $_SESSION['user_role_array']))) {
...
?>
    ...
    <div class="text-center form-group row">
        <a href="events_admin.php">Return to Events</a>
    </div>
</div>
</form>
<br/>
...
<script type="text/javascript" src="./js/event_v6.js"></script>
</body>
</html>
<?php
if (isset($conn)) {
