...
if (array_key_exists('confirm_submit', $_POST))   {
    ...
    isset($endo_status)?$endo_status:$endo_status="";
...
<?php   if(isset($submit_message))    {    
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
            <input type="text" class="form-control" name="endo_pseudo_name" id="endo_pseudo_name" placeholder="pseudo name" value="<?php echo $endo_pseudo_name;?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-2">
            <input type="text" class="form-control" name="endo_first_name" id="endo_first_name"  placeholder="First" value="<?php echo $endo_first_name;?>">
      </div>
      <div class="col-md-1">
            <input type="text" class="form-control" name="endo_middle_name" id="endo_middle_name" placeholder="Middle" value="<?php echo $endo_middle_name;?>">
      </div>
      <div class="col-md-2">
            <input type="text" class="form-control" name="endo_last_name" id="endo_last_name" placeholder="Last" value="<?php echo $endo_last_name;?>">
      </div>
      <div class="col-md-1">
            <input type="text" class="form-control" name="endo_name_suffix" placeholder="suffix" value="<?php echo $endo_name_suffix;?>">
      </div>
      <div class="col-md-1">
            <input type="text" class="form-control" name="endo_degree" placeholder="degree" value="<?php echo $endo_degree;?>">
      </div>
    </div>
    <div class="form-group row">
      <label class="control-label col-md-2" for="mail_name">Mail Name:</label>
      <div class="col-md-3">
            <input type="text" class="form-control" name="mail_name" id="mail_name" value="<?php echo $mail_name;?>">
      </div>
    </div>
    <div class="form-group row">
      <label class="control-label col-md-2" for="endo_address1">Address:</label>
      <div class="col-md-6">
        <input type="text" name="endo_address1" class="form-control endo_address" id="endo_address1" placeholder="Address line 1" value="<?php echo $endo_address1; ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-md-2" for="endo_address2"></label>
      <div class="col-md-6">
        <input type="text" name="endo_address2" class="form-control endo_address" id="endo_address2" placeholder="Address line 2" value="<?php echo $endo_address2; ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-md-2" for="endo_address3"></label>
      <div class="col-md-6">
        <input type="text" name="endo_address3" class="form-control endo_address" id="endo_address3" placeholder="Address line 3" value="<?php echo $endo_address3; ?>">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-md-2" for="endo_city">City:</label>
      <div class="col-md-2">
        <input type="text" name="endo_city" class="form-control address" id="endo_city" placeholder="City" value="<?php echo $endo_city; ?>">
      </div>
