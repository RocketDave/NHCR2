...
if (array_key_exists('confirm_submit', $_POST))   {
    ...
    try{
            $stmt = pg_prepare($conn,"the_query","select * from public.set_facility_pr($1,$2,$3,$4,$5,$6,$7,$8)");
            if ($stmt) {
...
<?php include("includes/header_f.php"); ?>
    ...
    <div class="form-group row">
        ...
        <label class="control-label col-md-1" for ="pth_req_sort_col"> Sort:</label> 
        <div class="col-md-2">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2">
            <input type="text" class="form-control" id="pth_reports_contact_phone" name="pth_reports_contact_phone" value="<?php echo $pth_reports_contact_phone;?>">
        </div>
