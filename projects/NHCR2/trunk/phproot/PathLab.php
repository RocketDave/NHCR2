...
<?php include("includes/header_pl.php"); ?>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-2">
            <input type="text" class="form-control" name="contact1_phone" placeholder="888-888-8888" title="XXX-XXX-XXXX" value="<?php echo $contact1_phone;?>">
        </div>
    ...
    <div class="form-group row">
        ...
        <label class="control-label col-md-1">Phone:</label>
        <div class="col-md-2">
            <input type="text" class="form-control" name="contact2_phone" placeholder="888-888-8888" title="XXX-XXX-XXXX" value="<?php echo $contact2_phone;?>">
        </div>
