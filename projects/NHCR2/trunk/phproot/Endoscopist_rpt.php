...
<div class="container-fluid ">
    ...
    <footer>
        <p class="small">*Data for all NHCR sites is provided from 4/2009, when the NHCR moved from a pilot study (2004-2009) to a state-wide registry, through the date for which pathology has been abstracted for all participating sites.
