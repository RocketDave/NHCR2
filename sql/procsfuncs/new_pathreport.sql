create or replace function public.new_path_report(
...
language plpgsql
security definer;
grant execute on function public.new_path_report(integer, character varying, character varying, character varying) to NHCR2_rc; 